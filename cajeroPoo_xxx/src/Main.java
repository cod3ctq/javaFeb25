...
public class Main {
    public static void main(String[] args) {
        ...
        //Ticket t3 = (Ticket) pract.retirar("C015", 2025)[0];
        //Ticket t4 = pract.depositar("C015", 7350);
      //  System.out.println(t4);
        /*
        Cajero c = new Cajero("Av. Juarez 5298",50,dataBase);

        Object[] data = c.buscar("C948534");
        System.out.println(data[0]);
        System.out.println(data[1]);

        Ticket t = c.consultarSaldo("CX12");
        ...
        //Transfiero una cantidad de una cuenta a otra, en este caso no deberia permitirme por que
        ...
        //Aqui valido que pasa cuando intento trasnferir un monto muy grande a la cuenta destino
        ...
        //En este caso, el pago der servicios se realizo correctamente
        //Ticket t10 = pract.pagarServicio("CFE","CFE005");
        //System.out.println(t10);

        //Aqui se comprueba el mensaje que se imprime cuando un determinado convenio NO existe
        try{
