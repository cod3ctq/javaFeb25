...
public class Main {
    public static void main(String[] args) {
        ...
        // CFE, AGUA, SAT, TELMEX
        // Crear las listas correspondiente y añadirlas al mapa
        ...
        // En este caso, este recibo relacionado a este convenio ya había sido pagado
        // Ticket t9 = pract.PagarServicio("AGUA","AGUA003");
        // System.out.println(t9);

        // En este caso, el pago de los servicios ser realizo correctamente
        // Ticket t10 = pract.PagarServicio("CFE","CFE005");
        // System.out.println(t10);

        // Aquí se comprueba el mensaje que se imprime cuando un determinado convenio NO existe
        //Ticket t11 = pract.pagarServicios("TELCEL","CFE005");
        ...
        //ystem.out.println(ticket);
        //System.out.println(ticket2);

        // Carga la base de datos (lista) de cuentas en la practicaja
        pract.setCuentasDB(dataBase);

        //Ticket t3 = (Ticket) pract.retirar("C015",2020)[0];
        //System.out.println(t3);

        //Ticket t4 = pract.depositar("C015",7299);
        //System.out.println(t4);

        // Transfiero una cantidad de una cuenta a otra, en este caso no deberia permitirme
        // por que no cuenta con esa cantidad
        // Ticket t5 = pract.trasnferir("C015","C016",5000);
        // En esta ocasion, si me alcanza el monto pero al hacerlo quedaria por debajo del minimo
        // Ticket t6 = pract.transferir("C012","C013",4400);

        // En este punto si debe dejarme hacer la transferencia
        // Ticket t7 = pract.transferir("C012","C013",1000);

        // Aquí valido que pasa cuando intento transferir un monto muy grande a la cuenta destino
        //Ticket t8 = pract.transferir("C009","C001",7500);
        //System.out.println(t8);


        // Aquí se comprueba que se imprime cuando un determinado convenio NO existe
        try
        {
            Ticket t11 = pract.pagarServicios("TELCEL","CFE005");
            System.out.println(t11);
