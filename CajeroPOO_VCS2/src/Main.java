...
public  class Main {
    public static void main(String[] args) {
        ...
        //Crear 20 cuentas y lista de cuentas
        // Cajero c = new Cajero();
      ...
      /*  Object[] data= c.buscar("C014");
        ...
        Ticket t3= (Ticket)  pract.retirar("C015", 1000)[0];
        System.out.println(t3);
        // En esta secion, si me alcanza el monto pero si hahacerlo quedaria por debajo del minimo

        //Ticket t5 = pract.transferirir("Hola", "BCDE", 50000);
        // En este punto si deja hacer la transferencia
        //Ticket t6 = pract.transferirir("Leo", "cmd", 1000);
        //Ticket t7 = pract.transferirir("Leo", "cmd", 1000);
        //Aqui valido que pase cuando intente transferir en monto muy grande o la cuenta distinta
        Ticket t8 = pract.transferirir("Leo", "0001", 7500);
        ...
        // Carga la db de sarvicios a practi caja
        pract.setRecibosBD(servicios);

        // En este caso, el pago de servicios se realiza correctamente
        //Ticket t9 = pract.pagarServicio("AGUA", "AGUA003");
        //System.out.println(t9);

        // Aqui se comprueba el mensaje que se imprime cuando un determinado servicio no existe
        Ticket t10 = pract.pagarServicio("telcel", "cfe004");
