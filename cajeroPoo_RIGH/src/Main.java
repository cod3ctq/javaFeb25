...
public class Main {
    public static void main(String[] args) {
        ...
        Map<String, List<Map<String, Object>>> servicios = new HashMap<>();

// CFE
        List<Map<String, Object>> cfe = new ArrayList<>();
        Map<String, Object> cfe1 = new HashMap<>();
        cfe1.put("folio", "1234567890");
        cfe1.put("monto", 1200.50);
        cfe1.put("pagado", true);
        cfe.add(cfe1);
        servicios.put("CFE", cfe);

// Agua
        List<Map<String, Object>> agua = new ArrayList<>();
        Map<String, Object> agua1 = new HashMap<>();
        agua1.put("folio", "9876543210");
        agua1.put("monto", 350.00);
        agua1.put("pagado", false);
        agua.add(agua1);
        servicios.put("Agua", agua);

// SAT
        List<Map<String, Object>> sat = new ArrayList<>();
        Map<String, Object> sat1 = new HashMap<>();
        sat1.put("folio", "0123456789");
        sat1.put("monto", 5000.00);
        sat1.put("pagado", true);
        sat.add(sat1);
        servicios.put("SAT", sat);

// TELMEX
        List<Map<String, Object>> telmex = new ArrayList<>();
        Map<String, Object> telmex1 = new HashMap<>();
        telmex1.put("folio", "9012345678");
        telmex1.put("monto", 800.00);
        telmex1.put("pagado", false);
        telmex.add(telmex1);
        servicios.put("TELMEX", telmex);

        Map<String,List<Recibo>> servicos = new HashMap<>();
        ...
        pract.setServiciosDb(servicos);

        Ticket ticket3 = (Ticket) pract.retirar("15345",1555)[0];
        System.out.println(ticket3);

       // Ticket ticket4 = pract.depositar("13345",200);
        //System.out.println(ticket4);

        //Ticket ticket5 =pract.transferir("14345","15345",500);
        //System.out.println(ticket5);
        Ticket ticket5 =pract.transferir("16345","15345",10);
        System.out.println(ticket5);
