    ...
    public static void main(String[] args) {
      ...
      /*  Object[] data= c.buscar("C014");
       ...
       // System.out.println(ticket2);
        ...
        System.out.println("Nuevo saldo: "+cuenta15.getSaldoDisponible());

        //Transfiero una cantidad de una cuenta a otra, een este caso no deberia permitirme por que
        //no cuenta con esa cantidad
        //Ticket t5=pract.transferir("C012", "C013", 5000);

        //En esta ocasion, si me alcanza el monto pero el hacerlo quedaria por debajo del minimo
        ...
        //cargo la db de servicios a la practicaja
