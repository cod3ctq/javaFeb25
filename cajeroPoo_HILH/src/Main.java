...
public class Main  {
    public static void main(String[] args) {
        ...
        //objetos de la lista y la lista en si misma.20 cuentas y la lista de cuentas
        ...
        pract.setUbicacion("Boulevard 5 de Mayo #288");
        bas.setUbicacion("Boulevard 5 de Mayo #288");
        //cargo la db de los retiros sin tarjeta
        bas.setRetiroSinTarjeta(retiros);
        pract.setRetiroSinTarjeta(retiros);
        //Ejecuta el metodo retiroSinTarjeta y guarda el ticket resultante
        //Ticket ticket=bas.retiroSinTarjeta();
        //Ticket ticket2=pract.retiroSinTarjeta();
        //System.out.println(ticket);
       // System.out.println(ticket2);
           /*Cajero c = new Cajero("Av. Juarez 5623",50,dataBase);

        //Implementa el metodo buscar
        Object[]data = c.buscar("C014");
        System.out.println(data [0]);
        System.out.println(data[1]);

        //Implementa metodo consultar saldo
        Ticket t=c.consultarSaldo("C012");
        System.out.println(t);
*/
        //Cargo la base de datos (lista) de cuentas en la practicaja
        pract.setCuentasDB(dataBase);
        Ticket t3= (Ticket) pract.retirar("C016",800)[0];
        Ticket t4= pract.depositar("C015",800);
       // System.out.println(t4);
        //Transfiero una cantidad de una cuenta a otra, en este caso no deberia permitirme por que no cuenta con esa cantidad.
        Ticket t5 =pract.trasferir("C012","C013",5000);
        //System.out.println(t5);
        Ticket t6 =pract.trasferir("C012","C013",7350);//despues de la transferencia me dejaria con menos del minimo
        //System.out.println(t6);
        Ticket t7 = pract.trasferir("C012","C013",1000);//si se pudo hacer la transferencia, imprime ticket
        //System.out.println(t7);
        Ticket t8 = pract.trasferir("C009","C001",7500);//Aqui valido que pasa cuando intento transferir un monto muy grande a la cuenta destino
        //System.out.println(t8);

        //Caga de la db de servicios a la practicaja
        pract.setRecibosDB(servicios);
        //Ticket t9 = pract.pagarServicio("AGUA","AGUA003"); //En este caso, el recibo ya esta en estado de pagado
        //System.out.println(t9);
        //Ticket t10 =pract.pagarServicio("CFE","CFE005");//El pago de servicios se concreto correctamente
        //System.out.println(t10);
        //Ticket t11 =pract.pagarServicio("TELCEL","CFE005");//Manda un mensaje si el convenio no existe
